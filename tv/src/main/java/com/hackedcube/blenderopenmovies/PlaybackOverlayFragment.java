...
public class PlaybackOverlayFragment extends android.support.v17.leanback.app.PlaybackOverlayFragment {
        ...
        playbackControlsRowPresenter.setOnActionClickedListener(new OnActionClickedListener() {
            public void onActionClicked(Action action) {
                if (action.getId() == mPlayPauseAction.getId()) {
                    ...
                    mFastForwardAction.setIndex(mFastForwardAction.getIndex() + 1);
                    mRewindAction.setIndex(0);
                } else if (action.getId() == mRewindAction.getId()) {
                    mRewindAction.setIndex(mRewindAction.getIndex() + 1);
                    mFastForwardAction.setIndex(0);
                }
    ...
    private void addPlaybackControlsRow() {
        ...
        mFastForwardAction = new PlaybackControlsRow.FastForwardAction(sContext, 16);
        mRewindAction = new PlaybackControlsRow.RewindAction(sContext, 16);
